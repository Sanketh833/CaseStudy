...
public class Books {
	...
	public Books(Integer id, String title, String category, String image, long price, String publisher, Boolean active,
			String content, String authorUserName, Integer aId) {
		super();
		this.id = id;
		this.title = title;
		this.category = category;
